...
class ResPartner(models.Model):
    ...
    def get_yo_contribuyo_information(self, cedula):
        ...
        if not get_yo_contribuyo_information:
            pass
    ...
    def get_tributary_information(self, cedula):
        ...
        if not get_tributary_information:
            pass
                    ...
                    for act in contenido.get("actividades"):
                        if act.get("estado") == "A":
                            self.activity_id = (
                                ...
                                .search([("code", "=", str(act.get("codigo")))], limit=1)
                                .id
                            )
        except requests.RequestException:
    ...
    def onchange_vat(self):
        if self.vat:
            self.get_tributary_information(self.vat)
            self.get_yo_contribuyo_information(self.vat)
